    ...
    return <Layout title={country.name}>
        <div className={styles.container}>
            ...
            <div className={styles.container_right}><div className={styles.details_panel}>
                ...
                <div className={styles.details_panel_row}>
                    <div className={styles.details_panel_label}>Languges</div>
                ...
                <div className={styles.details_panel_row}>
                    <div className={styles.details_panel_label}>Native nam</div>
                ...
                <div className={styles.details_panel_borders}>
                    <div className={styles.details_panel_borders_label}>Neighnboring countries</div>
